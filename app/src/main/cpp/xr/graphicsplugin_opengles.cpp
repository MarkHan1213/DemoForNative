...
Model3DSample* m_pCurSample = new Model3DSample();
...
struct OpenGLESGraphicsPlugin : public IGraphicsPlugin {
    ...
    void RenderView(const XrCompositionLayerProjectionView& layerView, const XrSwapchainImageBaseHeader* swapchainImage,
        ...
        m_pCurSample->UpdateTransformMatrix(pose.orientation.x,pose.orientation.y,0.5f,0.5f);
        m_pCurSample->Draw(layerView.subImage.imageRect.extent.width / 2,
                           layerView.subImage.imageRect.extent.height / 2);
